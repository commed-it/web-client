        ...
        <div className = "Header row d-flex flex-row customNavBar ustify-content-start">
            ...
            <div className="center col-xs-12 col-sm-12 col-md-7 col-lg-8">
                <form class="d-flex col-xs-8 col-sm-8 col-md-8 col-lg-8"> 
                    <input class="form-control col-xs-8 col-sm-8 col-md-8 col-lg-8" type="search" placeholder="Search" aria-label="Search"></input> 
                    <button class="btn btn-outline-light col-xs-2 col-sm-2 col-md-2 col-lg-1" type="submit">
            ...
            <div className="center col-xs-12 col-sm-12 col-md-3 col-lg-3 d-flex justify-content-end">
                <button class="btn btn-outline-light col-xs-6 col-sm-6 col-md-5 col-lg-4">
