...
function Header(props) {
  ...
  const handleSelect = (e) => {
    ...
    if (e == "products") navigate("/profile/" + logedUser.pk + "/products");
    if (e == "formaloffers") navigate("/profile/" + logedUser.pk + "/formaloffers");
  ...
  return (
    <div className="row d-flex flex-row customNavBar sticky-top ">
      ...
      {sessionExist() && (
        <div className="center col-xs-12 col-sm-12 col-md-3 col-lg-3 d-flex justify-content-end">
          <a className="button btn btn-sm col-xs-6 col-sm-6 col-md-5 col-lg-4 rounded-pill d-flex justify-content-center align-self-center" href="/chat" style={{ color: "white", textDecoration: "none" }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
