    ...
    <div role="document" borderRadius="0.8rem">
      <div className="window ">
        ...
        <div className="modal-body mx-3 border-0">
          ...
          <div class="md-form mb-5">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ced4da" class="bi bi-sticky-fill icons" viewBox="0 0 16 16">
          ...
          <div class="md-form mb-5">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ced4da" class="bi bi-person-badge-fill icons" viewBox="0 0 16 16">
