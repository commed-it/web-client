            ...
            { formalOffers && 
                <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-center' style={{ paddingTop: 20 }}>
                    <div className='col-xs-6 col-sm-6 col-md-6 col-lg-6'>
                        ...
                        <div className='col-xs-12 col-sm-12 col-md-12 col-lg-12 d-flex justify-content-center align-items-center divPagesAndButtons'>
                            <button className='btn buttonPagesChange col-xs-4 col-sm-3 col-md-2 col-lg-2' onClick={handlePrevPage}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-circle-fill iconSwitch" viewBox="0 0 16 16">
                            <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0zm3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5H11.5z"/>
                            </svg></button>
                            <div className='labelPages d-flex justify-content-center align-items-center'>
                                Page {pageNumber} of {numPages}
                            </div>
                            <button className='btn buttonPagesChange col-xs-4 col-sm-3 col-md-2 col-lg-2' onClick={handleNextPage} ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle-fill iconSwitch" viewBox="0 0 16 16">
